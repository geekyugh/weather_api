...
import {
  ...
  generateCyprusWeatherData,
  generateChinaWeatherData,
  ...
  try {
    ...
    if (city === "london") {
      ...
      finalWeatherData = generateDublinWeatherData();
        ...
        finalWeatherData = generateCyprusWeatherData();
    }    else if (city === "china") {
          finalWeatherData = generateChinaWeatherData();
    } 
    
    else {
      // If the city is not london, dublin, cyprus or china, we will throw an error
